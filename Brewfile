...
# brew "unixodbc"
# Command-line app that checks all of your apps for their Apple Silicon support
# brew "harryzcy/ascheck/ascheck"
...
cask "battle-net"
# Army list creator for tabletop wargamers
cask "battlescribe"
